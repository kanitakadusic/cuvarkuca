...
class ColorSpinnerAdapter (
    ...
    private val colorOnDisabled: Int = Utility.getAttrColor(context, com.google.android.material.R.attr.colorOutlineVariant)
    ...
    override fun getView(
        ...
        val icon = ContextCompat.getDrawable(context, R.drawable.ic_check_filled)
        icon?.setTint(
    ...
    override fun getDropDownView(
        ...
        val icon = ContextCompat.getDrawable(context, R.drawable.ic_circle_filled)
